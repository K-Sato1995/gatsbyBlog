...
- [【ruby 小ネタ】\$: や File.dirname(**FILE**)　が何なのかさっぱり分からなかった件 - 東京伊勢海老通信](https://altarf.net/computer/ruby/509)
...
- [Where Do I Put My Code In Rails (Updated)](http://codefol.io/posts/where-do-i-put-my-code-in-rails-updated/)
- [Checking for Changed Attributes in Ruby on Rails \| Jason Charnes](https://jasoncharnes.com/changed-attributes-rails/)
- [How to test Rails mailers using RSpec - Lucas Caton](https://www.lucascaton.com.br/2010/10/25/how-to-test-mailers-in-rails-with-rspec/)
- [Different Ways to Set Attributes in ActiveRecord (Rails 4)](https://davidverhasselt.com/set-attributes-in-activerecord/)
- [Working with or without time zones in Rails applications - makandra dev](https://makandracards.com/makandra/46009-working-with-or-without-time-zones-in-rails-applications)
- [ruby - How to return JSON from Rails with camelcased key names - Stack Overflow](https://stackoverflow.com/questions/44597294/how-to-return-json-from-rails-with-camelcased-key-names)
- [Building an API App with GraphQL and Trailblazer [Tutorial] Part 1 \| RubyGarage Blog](https://rubygarage.org/blog/graphql-and-trailblazer-tutorial)
...
- [How to start using UUID in ActiveRecord with PostgreSQL \| Arkency Blog](https://blog.arkency.com/2014/10/how-to-start-using-uuid-in-activerecord-with-postgresql/)
...
- [ActiveStorage で S3 にダイレクトアップロードする - Rails Webook](https://ruby-rails.hatenadiary.com/entry/20180818/1534597335)
...
- [Adding Token-Based Authentication to Rails API - Cory Baker - Medium](https://medium.com/@coryb08/adding-token-based-authentication-to-rails-api-5eb16a2900f3)
...
- [Jwt Auth Rails - Learn.co](https://learn.co/lessons/jwt-auth-rails)
- [GraphQL on Rails: On the way to perfection — Martian Chronicles, Evil Martians’ team blog](https://evilmartians.com/chronicles/graphql-on-rails-3-on-the-way-to-perfection)
- [Rails 5 API + JWT setup in minutes (using Devise) - Adam Mazur - Medium](https://medium.com/@mazik.wyry/rails-5-api-jwt-setup-in-minutes-using-devise-71670fd4ed03)
- [security - What is token based authentication? - Stack Overflow](https://stackoverflow.com/questions/1592534/what-is-token-based-authentication)
- [JWT について調べた内容をまとめました。 - Qiita](https://qiita.com/t-toyota/items/8d0ffb265845ab8cc87c)
...
- [【JavaScript 入門】誰でも分かる Promise の使い方とサンプル例まとめ！ \| 侍エンジニア塾ブログ（Samurai Blog） - プログラミング入門者向けサイト](https://www.sejuku.net/blog/52314)
...
- [Meet Material-UI — your new favorite user interface library](https://www.freecodecamp.org/news/meet-your-material-ui-your-new-favorite-user-interface-library-6349a1c88a8c/)
...
- [React.js の Component Lifecycle - Qiita](https://qiita.com/koba04/items/66e9c5be8f2e31f28461#componentwillmount)
...
- [reactjs - react counter for each item of list - Stack Overflow](https://stackoverflow.com/questions/53383864/react-counter-for-each-item-of-list)
- [Session Storage and Local Storage in React - RWieruch](https://www.robinwieruch.de/local-storage-react)
- [Query Strings with React Router](https://tylermcginnis.com/react-router-query-strings/)
...
- [react-router/history.md at master · ReactTraining/react-router · GitHub](https://github.com/ReactTraining/react-router/blob/master/packages/react-router/docs/api/history.md)
- [React Training: React Router v5.1](https://reacttraining.com/blog/react-router-v5-1/#usehistory) -[Hooks Introduced in React-Router v5.1 - DEV Community 👩‍💻👨‍💻](https://dev.to/finallynero/hooks-introduced-in-react-router-v5-1-7g8)
...
- [【React】新機能 hooks - Qiita](https://qiita.com/YutamaKotaro/items/ef0430f570779dcf8a26)
...
- [英語とプログラミングを同時に勉強するなら「Practical Object-Oriented Design in Ruby」の一択 - ベルリンの IT スタートアップで働くソフトウェアエンジニアのブログ](https://www.jabba.cloud/20150527234224/)
...
- [Dockerfile の書き方, 利用する命令, 作成手順 - わくわく Bank](https://www.wakuwakubank.com/posts/270-docker-build-image/)
...
- [Passwords and hacking: the jargon of hashing, salting and SHA-2 explained \| Technology | The Guardian](https://www.theguardian.com/technology/2016/dec/15/passwords-hacking-hashing-salting-sha-2)
...
- [Inspiratinal post](https://medium.com/@lydiahallie/advice-from-a-19-y-o-girl-software-developer-88737bcc6be5)
